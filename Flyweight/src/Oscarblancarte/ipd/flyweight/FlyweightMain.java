...
package Oscarblancarte.ipd.flyweight;
import Oscarblancarte.ipd.flyweight.impl.PlayItemFactory;
import Oscarblancarte.ipd.flyweight.impl.PlayList;
...
public class FlyweightMain {
    ...
    public static void main(String[] args) {
        System.out.println(""
                + "Proceso de creación de playlist iniciado, este procecso puede\n"
